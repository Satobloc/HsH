...
| Field | Value |
|---|---|
| Source | [`SAT_overview.txt`](https://github.com/Satobloc/SAT_THEORY_ARCHIVE_2023-25/blob/main/SAT_overview.txt) |
| Date | — |
| Development phase | — |
| Library selection | showcase |
| Candidate tier | III |
| Presentation status | trial candidate |
| Categories | overview, sat |
...
[Open the original source in the SAT Archive →](https://github.com/Satobloc/SAT_THEORY_ARCHIVE_2023-25/blob/main/SAT_overview.txt)
