...
Second, neutrino-pair emission is not forbidden as a generic consequence of matter interactions. Standard electroweak processes include neutrino-pair bremsstrahlung from electron-nucleus scattering in dense matter and radiative emission of neutrino pairs from atomic transitions. Macrocoherent atomic schemes have been studied specifically as possible ways to enhance otherwise rare neutrino-pair processes. These examples do **not** imply an observable neutrino yield from an ordinary slit or grating. They establish only that weak secondary radiation from interacting matter is a legitimate calculational category and that any proposed experiment must compare against the Standard Model floor appropriate to its actual beam, material, geometry, and energy scale.
...
The currently recovered historical provenance is narrower than the proposed weak-emission mechanism and is useful precisely because that boundary can be stated explicitly. In direct Nathan-authored SAT discussion from 5–6 April 2025 (`SAT Framework Analysis`, conversation `67f098c8-4ec0-8003-8bd1-0efa14ea4f66`), aperture and grating language is tied to filament/surface interaction and energy transfer, including a proposed light/photon-like response (messages `b19a4755-9afc-40b4-a0a8-2ecb6827f4a1`, `7c4551a6-44aa-40dc-a00d-1ba0fd7acbb4`, and `ae89e7f2-7256-4e5a-8402-deed8f8b89fe`). These records establish an antecedent for **boundary-mediated filament/surface interaction and energy/light response**. They do **not** establish that SAT in April 2025 predicted neutrino emission from an ordinary slit or grating, nor do they establish the later vocabulary of transient/detachable modes or t-/f-bosons. Formal archival citations should replace these audit locators before public release.
...
5. M. Yoshimura et al., literature on radiative emission of neutrino pairs and macrocoherent atomic neutrino spectroscopy; exact primary reference to be finalized after citation audit.
6. Atom-surface diffraction / nanograting phase-shift primary reference to be finalized after citation audit.
7. SAT/H(s)H earliest provenance sources: pending Mercer recovery; earliest direct documents must precede later SAT/H(s)H summaries in final bibliography.
