# GRURPLE-A — R1 SAT→H(s)H provenance table scaffold

**Branch/task:** CODE-GRURPLE / GRURPLE-A / R0→R1 / provenance
**Date:** 2026-09-22
...
| Programmatic compressed grammar | Sep–Dec 2025 Blockwave / One-Action | Historical slogans such as mass/misalignment, charge/twist, gravity/strain, motion/slicing belong to this period if verified | Completed derivations; present-day endorsement | PRIMARY FAMILY NEEDS EXACT SOURCE | OPTIONAL / CAREFUL |
| Public archive existence | 28 Dec 2025 archive release | Public archive release date | Public availability of every earlier private item; scientific validation | PUBLIC RELEASE ANCHOR NEEDS EXACT LINK | REQUIRED CHRONOLOGY ANCHOR |
| 4DHH / generator / holonomy / emergent-discreteness turn | Feb–Mar 2026 | Explicit hyperhelical-generator, holonomy, solver, He-3/Unit Cell, and continuous-geometry/emergent-readout work appears in this later SAT lineage | Backdating these structures to 2024/early 2025 | PRIMARY FAMILY NEEDS CLAIM-SPECIFIC SOURCES | USE ONLY IF PAPER COMPARES LINEAGE, NOT STRICT SAT |
| H(s)H finite-core worldtube continuation | Summer 2026 | Later lineage makes finite core, boundary/contact/deformation/penetration-exclusion explicit first-class modeling concerns | Calling these original SAT features without qualification | PRIMARY H(s)H SOURCES NEEDED | LABEL AS LATER CONTINUATION |

## Claim-strength ladder for manuscript use

1. **Recovered primary source establishes X on date D.** Use only with inspectable primary citation.
2. **X is documented before named contemporary paper Y.** Requires both primary dates; says chronology only.
...
- **STATUS THEN:** what the source itself was doing/claiming at that date.
- **STATUS NOW:** retained, modified, superseded, historical scaffold, open hypothesis, or later H(s)H continuation.
