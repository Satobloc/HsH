...
3. `WORKSPACES/COMMON/CURRENT_WORKFLOW_ORIENTATION.md`
4. current central task/branch, directive, milestone, check-in, and handoff state
5. only then the repository-specific sources needed for the selected task
