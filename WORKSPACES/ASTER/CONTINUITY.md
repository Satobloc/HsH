...
- Recover exact raw wording/date for Nathan's 2026-09-14 intellectual-provenance statement (own conceptual development; Minkowski/first-principles/general-science roots; little braid-math familiarity until recently; broad-popular string-theory familiarity). Treat as testimony, not novelty/priority validation.
...
- Steamroller source panel explicitly attests `Proton-Electron Mass Ratio — raw - .TXT`; null source id/row and negative searches mean unresolved underlying source, not established absence.
