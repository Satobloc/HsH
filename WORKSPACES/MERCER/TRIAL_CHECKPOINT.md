...
**Current through:** Run 93, 2026-09-17
...
## Run history
Runs 1–7 training/scanner; 8–12 Viewer navigation QA; 13 documentation convention; 14–22 glossary/crosswalk provenance; 23–26 docs reconciliation; 27 corpus counts; 28 external semantics; 29 duplicate collision; 30–37 integrity validator/harness; 38–46 Viewer acceptance/dedup diagnosis; 47–51 semantics-aware validator transition; 52–53 autotag lineage audit/handoff; 54–69 conversation-identity diagnostics; 70 Viewer exposure audit; 71 sidecar specification; 72–73 synthetic harness; 74 continuity + Sable handoff repair; 75 Nathan Direct lineage re-audit; 76 normalization current-state reclassification; 77–80 routing/front-door currentness; 81–85 Dashboard/operational-currentness micro-audits; 86–89 formalization access/history/signature/branch checks; 90 external Viewer provenance-field comparison; 91 merge implementation trace; 92 manual-catalog production-scope check; **93 traced partial curation through external-record ingestion and derived-copy materialization, identifying a latent external-only source-path mismatch while confirming whole-conversation hiding remains source-location independent.**

## Best next operations
1. Rotate to another fresh Viewer source-path-sensitive feature or extraction/sample QA target rather than elaborating the external curation mismatch absent interface movement.
2. Inspect Sable inbox on future runs; if Run-71 review activates, supply both external-source constraints (immutable identity and partial-curation source resolution) as distinct adjacent design evidence rather than opening duplicate requests.
