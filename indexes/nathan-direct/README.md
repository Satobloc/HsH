...
- input records: 75767
- input user records: 23367
- packaged unique user messages: 15187
- archive duplicate user records collapsed: 8180
- context dependent inherited tag records: 14504
- records missing conversation or message id: 0
- records with resolved parent graph pointer: 14507
...
- `nathan-direct-2026.jsonl` — 9121 records
